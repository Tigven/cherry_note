# Generated by Django 2.0.8 on 2018-08-09 15:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('offset', models.IntegerField(default=0, verbose_name='Offset')),
                ('justification', models.CharField(choices=[('LT', 'left'), ('RT', 'right'), ('CR', 'center')], default='LT', max_length=2)),
                ('name', models.CharField(max_length=1024, verbose_name='Image name')),
                ('anchor', models.CharField(default=models.CharField(max_length=1024, verbose_name='Image name'), max_length=1024, verbose_name='Anchor')),
                ('url', models.CharField(max_length=1024, verbose_name='Image URL')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('children', models.ManyToManyField(related_name='_note_children_+', to='notes.Note', verbose_name='Child notes')),
        ...
        migrations.AddField(
            model_name='note',
            name='tags',
            field=models.ManyToManyField(to='notes.Tag', verbose_name='Tags'),
        ),
        migrations.AddField(
            model_name='image',
            name='note',
